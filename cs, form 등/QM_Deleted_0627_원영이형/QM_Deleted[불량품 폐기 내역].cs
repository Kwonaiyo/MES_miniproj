...
namespace KDTB_FORMS
{
    public partial class QM_Deleted : DC00_WinForm.BaseMDIChildForm
    {
        ...
        { 
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "DELSEQ",         "폐기순번", GridColDataType_emu.VarChar,     80, HAlign.Center, true,  false);
            _GridUtil.InitColumnUltraGrid(grid1, "DELDATE",        "폐기일자", GridColDataType_emu.VarChar,    120, HAlign.Center, true,  false);
            _GridUtil.InitColumnUltraGrid(grid1, "DELNO",          "폐기번호", GridColDataType_emu.VarChar,    160, HAlign.Center, true,  false);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "FAULTQTY",       "폐기수량", GridColDataType_emu.Double,      80, HAlign.Right,  true,  false);
            _GridUtil.InitColumnUltraGrid(grid1, "UNITCODE",       "단위",     GridColDataType_emu.VarChar,    100, HAlign.Center, true,  false);
            _GridUtil.InitColumnUltraGrid(grid1, "DELWHY",         "불량원인", GridColDataType_emu.VarChar,    150, HAlign.Left,   true,  false);
            _GridUtil.InitColumnUltraGrid(grid1, "DELREASON",      "폐기사유", GridColDataType_emu.VarChar,    150, HAlign.Left,   true,  false);
            _GridUtil.InitColumnUltraGrid(grid1, "WORKER",         "작업자",   GridColDataType_emu.VarChar,     70, HAlign.Center, true,  false);
            _GridUtil.InitColumnUltraGrid(grid1, "MAKEDATE",       "등록일시", GridColDataType_emu.DateTime24, 160, HAlign.Center, true,  false);
            _GridUtil.InitColumnUltraGrid(grid1, "MAKER",          "등록자",   GridColDataType_emu.VarChar,    100, HAlign.Center, true,  false);
