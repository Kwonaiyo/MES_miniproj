...
namespace KDTB_FORMS
{
    public partial class QM_FaultRec : DC00_WinForm.BaseMDIChildForm
    {
        ...
        { 
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "FAULTNO",        "불량판정번호", GridColDataType_emu.VarChar,    200, HAlign.Center, true,  false);
            _GridUtil.InitColumnUltraGrid(grid1, "INOUTDATE",      "입/출일자",    GridColDataType_emu.VarChar,    120, HAlign.Center, true,  false);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "FAULTQTY",       "불량수량",     GridColDataType_emu.Double,     100, HAlign.Right,  true,  false);
            _GridUtil.InitColumnUltraGrid(grid1, "UNITCODE",       "단위",         GridColDataType_emu.VarChar,    100, HAlign.Center, true,  false);
            _GridUtil.InitColumnUltraGrid(grid1, "MAKER",          "등록자",       GridColDataType_emu.VarChar,     70, HAlign.Center, true,  false);
